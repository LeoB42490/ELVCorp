                        ...
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    {token ? (
                                        <button onClick={() => navigate("/profil")} className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-3 px-8 rounded-lg transition text-center">
                                            Voir le profil
                                        </button>
                                    ) : (
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-8 mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div onClick={() => navigate("/support")} className="p-6 border-2 border-gray-200 rounded-lg text-center hover:border-indigo-500 hover:bg-indigo-50 transition">
                                    <div className="text-4xl mb-3">🆘</div>
                                ...
                                <div onClick={() => navigate("/faq")} className="p-6 border-2 border-gray-200 rounded-lg text-center hover:border-indigo-500 hover:bg-indigo-50 transition">
                                    <div className="text-4xl mb-3">❓</div>

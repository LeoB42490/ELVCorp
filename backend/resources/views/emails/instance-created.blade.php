...
<head>
    ...
    <title>Votre instance est prête</title>
</head>
                ...
                <tr>
                    <td style="padding: 38px 34px 20px;">
                        ...
                        <p style="
                            ...
                            line-height: 25px;
                        ">
                            Le déploiement de votre instance a été effectué avec
                            succès. Elle est maintenant démarrée et prête à être
                            utilisée.
                        </p>
                        ...
                        >
                            ...
                            <tr>
                                ...
                                ">
                                    {{ $instance->ip_address ?? 'Non disponible' }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="
                                    ...
                                    font-size: 14px;
                                ">
                                    {{ optional($instance->created_at)->format('d/m/Y à H:i') }}
                                </td>
                            </tr>
                        </table>
                        ...
                        <p style="
                            ...
                            line-height: 23px;
                        ">
                            Conservez ces informations. Elles vous permettront
                            d’accéder à votre service et de l’administrer.
                        </p>
